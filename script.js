    ...
    $("#ruang").click(function (e) {
        ...
        for (var r = rows - 1; r >= 0; r--) {
            if (!board[r][col]) {
                ...
                if (checkWin(r, col)) {
                    isGameActive = false;
                    let winnerText = (currentPlayer === player1) ? "Player 1 (Merah) Menang! Klik Reset Permainan Untuk Mengulang Permainan" : "Player 2 (Kuning) Menang! Klik Reset Permainan Untuk Mengulang Permainan";
                    $("#notif").text(winnerText)
                    return;
                }
